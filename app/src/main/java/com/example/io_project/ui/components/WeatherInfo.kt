...
fun getIcon(weatherCode: Int) : Int
{
    when(weatherCode)
    {
        ...
        1 -> return R.drawable.ic_sunnycloudy
        2, 3 -> return R.drawable.ic_cloudy
        45,48 -> return R.drawable.ic_very_cloudy
        51,53,55,80,81,82 -> return R.drawable.ic_rainshower
        56,57,66,67 -> return R.drawable.ic_snowyrainy
        61,63,65 -> return R.drawable.ic_rainy
        71,85,86 -> return R.drawable.ic_snowy
        73,75,77 -> return R.drawable.ic_heavysnow
        95 -> return R.drawable.ic_thunder
        96,99 -> return R.drawable.ic_rainythunder
    }
        ...
        onSuccess = { lat, lon ->
            ...
            sendHttpRequest(url,
                ...
                { response ->
                    ...
                    if (data != null) {
                        WeatherData.temperature = data.first
                        WeatherData.code = data.second
                        WeatherData.acquired = true
